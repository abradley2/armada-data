module Gen.ShipData exposing (andMap, annotation_, attackDecoder, attackProfileDecoder, call_, caseOf_, defenseTokenDecoder, make_, maybe, moduleName_, shieldDecoder, shipDataDecoder, sizeDecoder, speedChartDecoder, tokenDecoder, upgradeSlotDecoder, values_, yawDecoder)

{-| 
@docs values_, call_, caseOf_, make_, annotation_, sizeDecoder, attackProfileDecoder, attackDecoder, shieldDecoder, defenseTokenDecoder, yawDecoder, speedChartDecoder, upgradeSlotDecoder, shipDataDecoder, tokenDecoder, andMap, maybe, moduleName_
-}
            ...
            , annotation =
                Just
                    (Type.function
                        ...
                        (Type.namedWith [] "Decoder" [ Type.var "b" ])
                    )
            }
        )
...
call_ :
    { maybe : Elm.Expression -> Elm.Expression
    , andMap : Elm.Expression -> Elm.Expression -> Elm.Expression
    , tokenDecoder : Elm.Expression -> Elm.Expression -> Elm.Expression
    }
call_ =
    { maybe =
        \maybeArg ->
